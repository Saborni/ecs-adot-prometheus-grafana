...
ECR_REPOSITORY_NAME=${ECR_REPOSITORY_NAME:-zap-app}
...
cd ../cloudformation/
# sed -e "s|\${ECR_REPO_URI}|${ECR_REPO_URI}|g" -e "s|\${IMAGE_TAG}|${IMAGE_TAG}|g" 2-ecs-fargate-template-default.yaml > 2-ecs-fargate-template.yaml
